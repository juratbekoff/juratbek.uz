...
export default function Home() {
    ...
    return (
        <div className="lg:flex lg:justify-between w-full h-[70vh] max-md:flex-col container">
            ...
            <span
                className="font-bold bg-gradient-to-r from-orange-600 via-orange-500 to-amber-600 bg-clip-text  text-transparent">
              Greetings from {""}
            </span>
              ...
              cReaTiVe Full Stack Javascript devEloper
                    ...
                    <p className="text-xl leading-normal text-neutral-700 max-md:text-lg max-md:text-center">
                        Hi, my name is{" "}
                        <b className="font-bold">Jur'atbek Xudayberganov</b> and I am{" "}
                        {age} {""}
